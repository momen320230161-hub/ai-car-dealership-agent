...
class SalesLead(Base, TimestampMixin):
    """Represents a customer contact/purchase intent lead."""
    ...
    car_id: Mapped[int | None] = mapped_column(
        Integer,
        ForeignKey("cars.id", ondelete="SET NULL", name="fk_sales_leads_car_id_cars"),
        nullable=True,
    )
    ...
    session: Mapped[ConversationSession] = relationship(
        "ConversationSession", back_populates="sales_leads"
    )
